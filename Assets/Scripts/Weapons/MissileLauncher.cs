...
public class MissileLauncher : MonoBehaviour {
    ...
    public void FireMissile(float damage, Transform _target,GameObject _origin)
    {
    ...
    public void FireClusterMissile(float damage, Transform _target,GameObject _origin)
    {
