...
public class AudioEngine : MonoBehaviour {
	...
	void Start () {
		...
		string[] audioTags = new string[] { 
			"Thrusters", "Laser", "MissleLaunch", "Torpedo", "Railgun", "MiningLaser", "missionTerminalEnd", "missionTerminalEnter", "TerminalEnter", "TerminalExit", "TerminalBtnYes", "TerminalBtn", "MenuPlayBtn", "Warning", "FtlMove", "FtlAlert", "FtlFlame", "Walk"
		};
